/**
 * PayTo step definitions â€” thin glue that delegates to {@link PayToPage}.
 *
 * "Given I am on the home screen" is defined here but, like every Cucumber
 * step, is global â€” the Merchant and Request Money features reuse it.
 */
...
Given('I am on the home screen', async function (this: TestWorld) {
  assert.ok(
    ...
    'expected to be on the home screen â€” Pay tab not found within 30s',
  );
});
